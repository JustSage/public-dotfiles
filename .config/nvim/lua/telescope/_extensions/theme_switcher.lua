        ...
        picker.close_windows = function(status)
            ...
            if reload_theme(final_theme) then
                if change then
                    ...
                    local ans = string.lower(vim.fn.input("Set " .. new_theme .. " as default theme ? [y/N] ")) == ("y" or "<CR>")
            ...
            -- set theme global var
            vim.g.theme = final_theme
        end
        -- launch the telescope picker
        picker:find()
    else
        print("No themes found in " .. vim.g.themes_folder)
    end
end
...
if present then
    return telescope.register_extension {
        exports = {
            theme_switcher = M.theme_switcher
        }
    }
else
