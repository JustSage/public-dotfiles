...
set "status-right" "#{prefix_highlight} #[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format} #[fg=$onedark_white,bg=$onedark_visual_grey] ${date_format} #[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets}#[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold]      "
set "status-left" "#[fg=$onedark_black,bg=$onedark_green,bold] #S "

set "window-status-format" "#[fg=$onedark_white,bg=$onedark_black] #I:#[fg=$onedark_white,bg=$onedark_black]#W #[fg=$onedark_black,bg=$onedark_black,nobold,nounderscore,noitalics]"
set "window-status-current-format" "#[fg=$onedark_blue,bg=$onedark_visual_grey,nobold] #I:#[fg=$onedark_white,bg=$onedark_visual_grey,nobold]#W "
